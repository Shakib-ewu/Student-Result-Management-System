...
if($count_auth==0)
{
 ...
 <html lang="en" dir="ltr">
   <head>
     <title>Assign Teacher to Courses</title>
     ...
     <nav class="navbar navbar-expand-lg navbar-light">
       <div class="container">
         <a class="navbar-brand" href="homepage.php">
           <img src="" height="75" class="d-inline-block" alt=""> <b><font color="red"></font> </b>
         </a>
        ...
        <center><b><h1>Available Courses</h1></b></center>
      ...
      <div class="middle">
        ...
        $result2=mysqli_query($connection,$query2);
            ...
            if(mysqli_num_rows($result)>0){
                            echo '<table class="table table-striped table-dark" border="1" cellpadding="10px">
                                <tr>
                                    <th>
                                        Course Name
                                    </th>
